...
<head>
  ...
  <title>Inteco Tecnologia Informática</title>
  <link href="<?php echo BASE_URL; ?>painel/assets/css/template.css" rel="stylesheet">
...
<div class="wrapper">
  ...
  <?php 
                ...
                $nomeabr = explode(" ",$_SESSION['nomeuser']);                
                $primeiro_nome = $nomeabr[0];
                if ($nomeabr[1] == 'Municipal') {
                    $segundo_nome = $nomeabr[3];
                } else {
                    $segundo_nome = $nomeabr[1];
                }
                
                $nomeabr = $primeiro_nome.' '.$segundo_nome;
                
   ?>

  <header class="main-header">
    <!-- Logo -->
    <a href="<?php echo BASE_URL; ?>painel" class="logo">
      <!-- mini logo for sidebar mini 50x50 pixels -->
      <span class="logo-mini"><b>I</b>nteco</span>
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg"><b>Inteco</b>Tecnologia</span>
    </a>
    <!-- Header Navbar: style can be found in header.less -->
    <nav class="navbar navbar-static-top">
      <!-- Sidebar toggle button-->
      <a href="#" class="sidebar-toggle" data-toggle="push-menu" role="button">
        <span class="sr-only">Toggle Inteco</span>
      </a>
        ...
        <ul class="nav navbar-nav">          
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              <img src="<?php echo BASE_URL; ?>painel/assets/images/usuarios/<?php echo $imagemuser; ?>" class="user-image" alt="User Image">
              <span class="hidden-xs"><?php echo utf8_encode($nomeuser); ?></span>
            </a>
            <ul class="dropdown-menu">
              <!-- User image -->
              <li class="user-header">
                <img src="<?php echo BASE_URL; ?>painel/assets/images/usuarios/<?php echo $imagemuser; ?>" class="img-circle" alt="User Image">

                <p>
                  <?php echo utf8_encode($nomeuser); ?>
                  <small>Painel Administrativo - Inteco Tecnologia</small>
                </p>
              </li>
              <!-- Menu Body -->
              ...
              <li class="user-footer">
                <?php if($tipouser < 3): ?>
                <div class="pull-left">
                  <a href="<?php echo BASE_URL; ?>painel/caduser/edit/<?php echo $_SESSION['lginteco']; ?>" class="btn btn-default btn-flat">Perfil</a>
                </div>
                <?php endif; ?>
                <div class="pull-right">
                    
                  <a href="<?php echo BASE_URL; ?>painel/login/logout" class="btn btn-danger btn-flat">Sair</a>
                </div>
              </li>
            </ul>
          </li>
  ...
  <footer class="main-footer">
    ...
    <strong>Copyright &copy; 2018 <a href="http://www.inteco.com.br/" target="_blank">Inteco Tecnologia</a>.</strong> Todos direitos reservados.
  </footer>
...
<script src="<?php echo BASE_URL; ?>painel/assets/js/script_valor.js" /></script>
<!-- Input Masks -->
<script src="<?php echo BASE_URL; ?>painel/assets/js/jquery.maskMoney.js" /></script>
<script src="<?php echo BASE_URL; ?>painel/assets/js/jquery.mask.js"></script>
<!-- Input Masks -->
